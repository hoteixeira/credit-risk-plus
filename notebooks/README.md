...
Foram mantidos nove notebooks. Todos executam integralmente, sem erro, usam a API matemática canônica e distinguem o quantil discreto do modelo da interpolação usada apenas para reproduzir a planilha oficial. Os exemplos oficiais contêm asserções de regressão e o estudo PF contém controles de horizonte, massa truncada e cobertura dos quantis.
